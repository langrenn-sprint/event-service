...
class EventFormatAdapter(Adapter):
    ...
    async def create_event_format(
        ...
        _ = event_id
        return await db.event_format_collection.insert_one(event_format)
    ...
    async def get_event_format(
        ...
        _ = event_id
        return await db.event_format_collection.find_one()
    ...
    async def update_event_format(
        ...
        _ = event_id
        return await db.event_format_collection.replace_one({}, event_format)
    ...
    async def delete_event_format(
        ...
        _ = event_id
        return await db.event_format_collection.delete_one({})
