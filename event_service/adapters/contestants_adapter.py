...
class ContestantsAdapter(Adapter):
    ...
    async def create_contestant(
        ...
        _ = event_id
        return await db.contestants_collection.insert_one(contestant)
    ...
    async def get_contestant_by_id(
        ...
        return await db.contestants_collection.find_one(
    ...
    async def update_contestant(
        ...
        return await db.contestants_collection.replace_one(
    ...
    async def delete_contestant(
        ...
        return await db.contestants_collection.delete_one(
            {"$and": [{"event_id": event_id}, {"id": contestant_id}]}
        )
    ...
    async def delete_all_contestants(
        ...
        return await db.contestants_collection.delete_many({"event_id": event_id})
