...
from app.adapters import ContestantsAdapter, EventsAdapter
...
class ContestantsCommands:
    ...
    async def assign_bibs(  # noqa: C901
        cls: Any, event_id: UUID, start_bib: int | None = 1
    ) -> None:
        ...
        seed = int.from_bytes(event_id.bytes, "little") % (2**32)
        ...
        for _c in contestants:
            ...
            await ContestantsService.update_contestant(event_id, _c.id, _c)
